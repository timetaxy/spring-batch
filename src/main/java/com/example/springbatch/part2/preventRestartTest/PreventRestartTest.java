package com.example.springbatch.part2.preventRestartTest;
...
public class PreventRestartTest {
    ...
    public Job batchJob() {
        return jobBuilderFactory.get("batchJob")
                .start(step1())
                .next(step2())
                .preventRestart()   // preventRestart로 선언하면 default : false, CommonJobProperties에서 지정
                .build();
    }
